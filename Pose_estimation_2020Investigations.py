...
file_prefix='2020_Inceptionv3_600'
...
class Camera:
    ...
    ppx = 5.86e-6*600/nu # horizontal pixel pitch[m / pixel]
...
class KerasDataGenerator(Sequence):#Sequence
        ...
        def __init__(self, 
            ...
            self.ppx = 5.86e-6*600/nu # horizontal pixel pitch[m / pixel]
...
#        # Training the model (transfer learning)
    ...
    model_final.load_weights(filepath=file_prefix+str(input_img_size[0])+'current_best.hdf5', by_name=True)
