...
class Camera:
    ...
    nu = 224  # number of horizontal[pixels]
    nv = 224  # number of vertical[pixels]
    ppx = 5.86e-6*1200/224 # horizontal pixel pitch[m / pixel]
...
class SatellitePoseEstimationDataset:
    ...
    def get_image(self, i=0, split='train'):
        ...
        image = Image.open(img_name.replace('jpg', 'png')).convert('RGB')
        return image
...
dataset_root_dir = r'C:\DeepLearningFolder\Poise Estimation\speed'
