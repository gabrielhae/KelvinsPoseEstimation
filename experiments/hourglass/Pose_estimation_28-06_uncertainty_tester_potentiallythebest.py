...
file_prefix='Inceptionv3_production'
...
#        # Training the model (transfer learning)
    ...
    model_final.load_weights(filepath='Inceptionv3_production600current_best.hdf5', by_name=True)#str(input_img_size[0])+'_pose_bestmodel.hdf5')
