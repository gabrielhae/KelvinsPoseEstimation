...
def InceptionV3(include_top=True,
    ...
    if attention_module is not None:
        x = attach_attention_module(x, attention_module,module_id=1)
    ...
    # attention_module
    if attention_module is not None:
        x = attach_attention_module(x, attention_module,module_id=2)
    ...
    # attention_module
    if attention_module is not None:
        x = attach_attention_module(x, attention_module,module_id=3)
    ...
    # attention_module
    if attention_module is not None:
        x = attach_attention_module(x, attention_module,module_id=4)
    ...
    # attention_module
    if attention_module is not None:
        x = attach_attention_module(x, attention_module,module_id=5)
    ...
    for i in range(2):
        ...
        # attention_module
        if attention_module is not None:
            x = attach_attention_module(x, attention_module,module_id=6+i)
    ...
    # attention_module
    if attention_module is not None:
        x = attach_attention_module(x, attention_module,module_id=8)
    ...
    # attention_module
    if attention_module is not None:
        x = attach_attention_module(x, attention_module,module_id=9)
    ...
    for i in range(2):
        ...
        # attention_module
        if attention_module is not None:
            x = attach_attention_module(x, attention_module,module_id=10+i)
