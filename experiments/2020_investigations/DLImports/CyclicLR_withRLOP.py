            ...
            if self.monitor_op(current, self.best):
                ...
                if self.wait >= self.patience:
                    ...
                    if old_lr > self.min_lr:
                        ...
                        K.set_value(self.model.optimizer.lr, new_lr)#entry point for new cycle
                        self._reset(new_base_lr=new_lr,new_max_lr=self.max_lr,new_step_size=self.step_size)
                        if self.verbose > 0:
