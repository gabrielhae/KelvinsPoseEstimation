...
class BatchNormalizationF16(Layer):
    ...
    def __init__(self,
        ...
        self.moving_mean_initializer = keras.initializers.get(moving_mean_initializer)
        self.moving_variance_initializer = (
            keras.initializers.get(moving_variance_initializer))
    ...
    def get_config(self):
        config = {
            ...
            'moving_mean_initializer':
                keras.initializers.serialize(self.moving_mean_initializer),
            'moving_variance_initializer':
                keras.initializers.serialize(self.moving_variance_initializer),
