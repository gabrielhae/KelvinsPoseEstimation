...
#        model_final.load_weights("tmp.h5", by_name=True)        
    ...
    #pred_model_final.compile(loss={'q': geodesic_loss, 'r': mse},loss_weights=[2.0,1.0], optimizer=opt,metrics={'q': [geodesic_angular_loss], 'r': [r2_loss,ev_loss]})#,metrics=['accuracy','cosine_proximity','mean_squared_error',lr_metric])
