...
from tensorflow.keras.callbacks import Callback,CSVLogger,History,ModelCheckpoint,ProgbarLogger,ReduceLROnPlateau,TensorBoard,EarlyStopping
...
#        rvecfork = keras.layers.Dropout(0.5)(rvecfork)          
        ...
        qvec=keras.layers.Dense(4, activation="tanh",name='q',kernel_regularizer=l2(0.01))(rvecfork)
